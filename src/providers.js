...
(function(global) {
  const CWA_PROVIDER_CONFIG = Object.freeze({
    openai: {
      ...
      models: ['gpt-4o-mini', 'gpt-5-nano', 'gpt-5-mini', 'gpt-4o'],
    ...
    deepseek: {
      ...
      keyPlaceholder: 'sk-...',
      keyHint: 'Key stored in chrome.storage.sync and only sent to api.deepseek.com. deepseek-chat is a legacy compatibility model.',
